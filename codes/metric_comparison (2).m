% Define directories
gt_dir = 'cell500/';
paper_dir = '08_results_cells/';
new_dir = 'Segmented_Cell_Results/';
% Number of images
num_images = 300;
...
for i = 1:num_images
    ...
    file_paper = sprintf('%s%03d.png', paper_dir, i);
    file_new = sprintf('%sProcessed_Processed_Slice_%03d.tif', new_dir, i);
    % Read images
    gt = imread(file_gt);
